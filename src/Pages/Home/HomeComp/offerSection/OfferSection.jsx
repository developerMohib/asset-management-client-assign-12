        ...
        <section className="pt-12">
            <div className="mx-auto relative md:flex justify-around items-center">
                ...
                <div className="rounded-sm px-2 text-center mt-5">
                    <h2 className="text-textPri text-5xl font-bold ">Exclusive offer</h2>
                    <p className="text-textPri text-2xl font-medium leading-9">Unlock the ultimate style upgrade with our exclusive offer Enjoy savings of up to 40% off on our latest New Arrivals</p>
                    <div className="flex gap-9 my-10 items-center justify-center">
                        <div className="w-24 h-24 text-center py-4 bg-white rounded-sm shadow-md">
                    ...
                    <button className="px-16 py-5 bg-primary hover:bg-btnHover rounded-sm shadow-md text-white text-xl font-medium uppercase">BUY NOW</button>
                </div>
            </div>
        </section>
    );
